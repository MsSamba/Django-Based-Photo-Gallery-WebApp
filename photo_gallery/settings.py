...
SECRET_KEY = 'django-insecure-aa)ivu%)q2370=x$uqu6-(qjr5i*k7r0ocyg1e(sagcxs$=5kr'
...
INSTALLED_APPS = [
    ...
    'photo_gallery_app.apps.PhotoGalleryAppConfig',
]
